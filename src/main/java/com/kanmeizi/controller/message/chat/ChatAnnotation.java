package com.kanmeizi.controller.message.chat;


import com.kanmeizi.util.HtmlFilter;
...
public class ChatAnnotation {
    ...
    private static final AtomicInteger connectIds = new AtomicInteger(0);
    private static final Set<ChatAnnotation> connections = new CopyOnWriteArraySet<ChatAnnotation>();
    private final String nickname;
    private Session session;

    public ChatAnnotation(){
        nickname = GUEST_PREFIX + connectIds.getAndIncrement();
    }
